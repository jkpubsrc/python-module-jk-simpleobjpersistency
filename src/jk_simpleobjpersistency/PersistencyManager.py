...
class PersistencyManager(object):
	...
	#
	# Creates a new object instance and adds it to this persistency mangement infrastructure.
	#
	...
	#
	# Add an already existing object to the persistency mangement infrastructure.
	#
	...
	def getObject(self, clazz:type, identifier):
		assert clazz is not None
	...
	def getObjectE(self, clazz:type, identifier):
		assert clazz is not None
